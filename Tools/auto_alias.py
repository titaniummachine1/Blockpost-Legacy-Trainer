...
METHOD_OVERRIDES = {
    ...
    "NET": {
        "LPAPGKDAENI": "Begin",
        "EMJOGONJKIO": "End",
        # Writers (void return, one typed arg) — mapped by signature analysis
        "ANJDGFJMIAL": "WriteInt",
        "HMCNFGMBCOC": "WriteShort",
        "HIPPJGAHHPC": "WriteFloat",
        "IFINMFCPGIB": "WriteShort2",
        "LHMNDGLMOFO": "WriteInt2",
        "MJDOMFPOPMK": "WriteUlong",
        "KOIHHCOBIEJ": "WriteString",
        "GJBAJNCFBLB": "WriteInt3",
        "LMKOIABBCNK": "WriteByte",
        "KLPOMLKDPAL": "WriteInt4",
        "PFCLIPCCHCK": "WriteByte2",
        "FPELFNLEPGG": "WriteInt5",
        "KMEFAPEEHHN": "WriteString2",
        "JBIICNJNHCI": "WriteFloat2",
        "EKDBCDKOJAO": "WriteUlong2",
        "APNPMHBBLDG": "WriteShort3",
        "EDICJCKFAMN": "WriteUlong3",
        "CHIOALKDHOC": "WriteInt6",
        "IHLNBLGFGLF": "WriteShort4",
        "PIMOAOKDDCC": "WriteFloat3",
        "PJFMOLFBKHM": "WriteString3",
        "GDDMJBCNMPK": "WriteInt7",
        "AGIJMMKMPPB": "WriteBytes",
        "OANLLALAOGK": "WriteBytes2",
        "NPPBJCOFBMD": "WriteBytes3",
        "DMFHJJDMAEJ": "Begin2",
        # Readers (return value, no args) — mapped by return type
        "JKONBLNHFLL": "ReadInt",
        "IFIEBMLBNIN": "ReadInt2",
        "DMKDAMBHBKJ": "ReadInt3",
        "KCDFEGLDEBM": "ReadInt4",
        "IEPCDJHHEAD": "ReadInt5",
        "CPJFIPAICPM": "ReadFloat",
        "OPGALLFGLDJ": "ReadFloat2",
        "NINKOINIPIG": "ReadFloat3",
        "ADBHAOJHEEK": "ReadString",
        "ODONEEFGGDP": "ReadInt6",
        "JIBFMIPGJEF": "ReadFloat4",
        "CDGNKLILDIP": "ReadString2",
        "ECDGGIONOHM": "ReadUlong",
        "MGAGAGENJIE": "ReadInt7",
        "ACGEGCEGCOH": "ReadInt8",
        "IEODJLBCHFK": "ReadInt9",
        "MFBDMLMBNLO": "ReadFloat5",
        "OIONBLPJDBI": "ReadUint",
        "GEMJCEIJLBN": "ReadInt10",
        "AIFLIHKAMAE": "ReadString3",
        "ACMJOHANGEG": "ReadInt11",
        "MFAIOGPHJPL": "ReadBool",
        # Readers with args (read at offset / read N bytes)
        "HJMOENIPJOL": "ReadBytes",
        "EFLCFHEKEGJ": "ReadBytes2",
        "GDAFLNGIOBD": "ReadBytes3",
        "HDIOCFKKBND": "ReadBytes4",
        # Control
        "NFOMAHCEFCL": "Reset",
    },
}
...
FIELD_OVERRIDES = {
    ...
    "NET": {
        ...
        "PBNGKNKPGEC": "WriteY",
        "NJCEGPBLLFJ": "WriteZ",
        "GLPMIOHOEOG": "SendBuffer",
        "JGDCFADACPP": "SendLength",
        "CDKEENLDMNG": "ReceiveBuffer",
        "PMDHKLGLDDA": "TempBuffer",
        "CGMLOPLCEGP": "ReceiveLength",
        "EAMFEKPMFEL": "SendPosition",
        "GAOGNNCPJGP": "IsWriting",
        "DBOGGPHNOPB": "ReadPosition",
        "LPDEFAFCLNC": "WritePosition",
        "KEHFECFHDHD": "BufferSize",
        "PMNIDNIJKCN": "WritePosition2",
    },
}
